...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Vehicles_HEMTT = ["Exile_Car_HEMMT","R3F_HEMTT_trans"];
	...
	IL_Supported_Vehicles_MOHAWK = ["Exile_Chopper_Mohawk_FIA","R3F_MERLIN_CE","R3F_MERLIN_DA"];
	...
	IL_Supported_HEMTT = ["Exile_Car_HEMMT","R3F_HEMTT_CE_log","R3F_HEMTT_DA_log","R3F_HEMTT_trans"];
	IL_Supported_KAMAZ = 
	[
		"I_Truck_02_covered_F",
		"I_Truck_02_transport_F",
