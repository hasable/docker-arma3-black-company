...
[
	[
		...
		8, // Minimum amount of AI at the start of mission (12)
        16, // Maximum amount of AI at start of mission ( If you want it to always be a number change MIN and MAX to the same number. )
        true, // deploy smoke on the circle border when mission is finished (14)
        60, // ammount of seconds to wait before deploying the smokescreen (15)
		...
		[ // array of waves of AI () (18)
			[
				...
				6, // Amount of AI units in a group
			...
			[
				...
				4, // Amount of AI units in a group
				3, // Amount of AI groups
				200, // distance in meter form ZCP for the ai to spawn
				true // false -> all groups from 1 random location, true -> all groups from their own random location
			]
		],
		2, // Minimum amount of launchers for starting AI (19)
        4, // Maximum amount of launchers for starting AI (20)
        1, // Minimum amount of launchers for Wave AI (21)
        2,  // Maximum amount of launchers for Wave AI (22)
    ...
    [
        ...
        2, // Minimum amount of launchers for starting AI
        4, // Maximum amount of launchers for starting AI
        1, // Minimum amount of launchers for Wave AI
        2, // Maximum amount of launchers for Wave AI
